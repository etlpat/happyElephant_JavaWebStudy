...
public class TxAdvice {
    ...
    public void begin(JoinPoint joinPoint) {
        System.out.println(joinPoint.getSignature().getName() + "方法：开启事务");
    }


    // 提交事务
    @AfterReturning(value = "execution(* com.etlpat..*.*(..))", returning = "returnValue")
    public void commit(JoinPoint joinPoint, Object returnValue) {
        System.out.println("返回值为：" + returnValue);
        System.out.println(joinPoint.getSignature().getName() + "方法，提交事务");
    }
    ...
    public void rollback(JoinPoint joinPoint, Throwable throwable) {
        ...
        System.out.println(joinPoint.getSignature().getName() + "方法，回滚事务");
    }
    ...
    public void end(JoinPoint joinPoint) {
        System.out.println(joinPoint.getSignature().getName() + "方法，finally结束");
    }
